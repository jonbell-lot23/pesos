  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-blue-100 to-white p-4">
      ...
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        <p className="mb-4">
          Congratulations! Your PESOS* account has been successfully set up.
          We've scheduled nightly automated backups for your RSS feeds, ensuring
          you control your stuff, even when sites go dark, or turn into nazis,
          or whatever.
        </p>
